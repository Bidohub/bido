...
contract SampleMother is Initializable, SampleHuman {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleMother_init_unchained(uint256 value)
        internal
        onlyInitializing
    {
        mother = value;
...
contract SampleGramps is Initializable, SampleHuman {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleGramps_init(string memory value)
        internal
        onlyInitializing
    {
        __SampleHuman_init();
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleGramps_init_unchained(string memory value)
        internal
        onlyInitializing
    {
        gramps = value;
...
contract SampleFather is Initializable, SampleGramps {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleFather_init(string memory _gramps, uint256 _father)
        internal
        onlyInitializing
    {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleFather_init_unchained(uint256 _father)
        internal
        onlyInitializing
    {
        father = _father;
...
contract SampleChild is Initializable, SampleMother, SampleFather {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __SampleChild_init_unchained(uint256 _child)
        internal
        onlyInitializing
    {
        child = _child;
